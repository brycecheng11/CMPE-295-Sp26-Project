...
## - rename the usedafter get_ports) according to the top level signal names in the project
...
##Pmod Header JA (XADC)
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { anchor1_tx }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { tx_2 }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { rx_2 }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P
...
##MPU-6050 connected to Pmod JB
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { anchor1_tx }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { anchor1_rx }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]
...
#Pmod Header JC
#set_property -dict { PACKAGE_PIN V15    IOSTANDARD LVCMOS33     } [get_ports IIC_0_0_scl_io ]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN W15    IOSTANDARD LVCMOS33     } [get_ports IIC_0_0_sda_io ]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]
...
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { rx_0 }]; #IO_L1P_T0_34 Sch=jc_p[2]
...
# JC Pin 1
#set_property -dict { PACKAGE_PIN V15 IOSTANDARD LVCMOS33 } #   [get_ports {new_angle_available_0_0[0]}]

# JC Pin 2
#set_property -dict { PACKAGE_PIN W15 IOSTANDARD LVCMOS33 } #   [get_ports {new_target_angle_available_0_0[0]}]

#Pmod Header JD
##set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { anchor3_tx }]; #IO_L5P_T0_34 Sch=jd_p[1]
##set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { tx_1 }]; #IO_L5N_T0_34 Sch=jd_n[1]
##set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { rx_1 }]; #IO_L6P_T0_34 Sch=jd_p[2]
...
##Pmod Header JE
##set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports IIC_0_0_scl_io ]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]
##et_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports IIC_0_0_sda_io ]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]
