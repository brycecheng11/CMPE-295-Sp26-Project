...
HD_PWD='/home/kenny/Downloads/can_communication/can_communication.runs/design_1_PmodCAN_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodCAN_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodCAN_0_0.tcl
